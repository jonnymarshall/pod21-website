...
const svgContent = `<svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const NotesSVG = createIconComponent(svgContent, "NotesSVG");
